...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["editor_registration"])) {
    ...
    $sql = "INSERT INTO reviwers (username, password) VALUES ('$editor_username', '$editor_password')";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["editor_login"])) {
    ...
    $sql = "SELECT * FROM reviwers WHERE username = '$editor_login_username' AND password = '$editor_login_password'";
